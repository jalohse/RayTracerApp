 ...
 */
public class MediumTextureImage implements GenericImage{

    int rowsColumns = 500;
    long milliseconds;
    private File path;

    public MediumTextureImage(Resources res, File path, File texturepath) {
        this.path = path;
        ...
        sphere.addTexture(new ImageTexture(res, R.drawable.textmdmap, texturepath));
