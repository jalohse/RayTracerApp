 ...
 */
public class SmallTextureImage implements GenericImage{

    int rowsColumns = 500;
    long milliseconds;
    private File path;

    public SmallTextureImage(Resources res, File path, File texturepath) {
        this.path = path;
        ...
        sphere.addTexture(new ImageTexture(res, R.drawable.textsmmap, texturepath));
