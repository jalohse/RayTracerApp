 ...
 */
public class LargeTextureImage implements GenericImage{

    int rowsColumns = 500;
    long milliseconds;
    private File path;

    public LargeTextureImage(Resources res, File path, File texturepath) {
        this.path = path;
        ...
        sphere.addTexture(new ImageTexture(res, R.drawable.textlgmap, texturepath));
